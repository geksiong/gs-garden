...
- Once you can ssh in:
  ...
  - Docker compose must be installed manually: `sudo curl -L https://github.com/docker/compose/releases/latest/download/docker-compose-$(uname -s)-$(uname -m) -o /usr/local/bin/docker-compose`
